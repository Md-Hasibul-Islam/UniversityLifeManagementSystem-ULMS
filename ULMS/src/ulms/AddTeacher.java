...
public class AddTeacher implements ActionListener{
    ...
    AddTeacher(){
        ...
        id8= new JLabel("SSC(GPA)");
        id8.setBounds(400,240,130,30);
        ...
        id9= new JLabel("HSC(GPA)");
        id9.setBounds(50,290,130,30);
	...
	lab.setFont(new Font("serif",Font.BOLD,20));
        ...
        c1.setBounds(200,340,150,30);
        id15.add(c1);
        
        lab2=new JLabel("Department");
        lab2.setBounds(400,340,150,30);
	lab2.setFont(new Font("serif",Font.BOLD,20));
        ...
        c2.setBounds(600,340,150,30);
        id15.add(c2);
        
        id11= new JLabel("Teacher ID");
        ...
        t11.setBounds(200,390,150,30);
        id15.add(t11);
        
        b = new JButton("Submit");
        b.setBackground(Color.BLACK);
        b.setForeground(Color.WHITE);
        b.setBounds(250,440,150,40);
