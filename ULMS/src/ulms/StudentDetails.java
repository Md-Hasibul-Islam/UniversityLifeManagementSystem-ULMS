...
public class StudentDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","SSC(GPA)", "HSC(GPA)", "NID No","ID","Course","Department"};
    String y[][] = new String[20][13];
    int i=0, j=0;
    StudentDetails(){
        super("ULMS - Student Details");
        setSize(1260,650);
        setLocation(50,50);
        setLayout(null);
        
        l1 = new JLabel("Enter Student ID to Delete Student : ");
