...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","SSC(GPA)", "HSC(GPA)", "NID No","Course","Department", "Teacher ID"};
    String y[][] = new String[20][13];
    int i=0, j=0;
    TeacherDetails(){
        super("ULMS - Teacher Details");
        setSize(1260,650);
        setLocation(50,50);
        setLayout(null);
        
        l1 = new JLabel("Enter Teacher ID to Delete Teacher : ");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b1){
            try{
                String a = t2.getText();
                String q = "delete from teacher where tcr_id = '"+a+"'";
