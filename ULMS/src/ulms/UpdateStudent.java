...
class UpdateStudent implements ActionListener{
    ...
    UpdateStudent(){;
        f=new JFrame("ULMS - Update Student Details");
        f.setSize(900,650);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                Conn con = new Conn();
                String str = "update student set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',nid='"+t10.getText()+"',course='"+t13.getText()+"',dept='"+t14.getText()+"' where id='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                Conn con = new Conn();
                String str = "select * from student where id = '"+t12.getText()+"'";
