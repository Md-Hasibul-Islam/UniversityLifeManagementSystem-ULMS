...
public class EnterMarks extends JFrame implements ActionListener{
    ...
    EnterMarks(){ 
        ...
        l1.setBounds(90,0,500,80);
        add(l1);

        l2 = new JLabel("Enter Student ID");
        l2.setBounds(90,90,200,40);
        add(l2);

        t1 = new JTextField();
        t1.setBounds(190,100,200,20);
        add(t1);
