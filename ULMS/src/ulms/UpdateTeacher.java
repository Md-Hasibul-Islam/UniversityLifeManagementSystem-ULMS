...
class UpdateTeacher implements ActionListener{
    ...
    UpdateTeacher(){
        f=new JFrame("ULMS - Update Teacher Details");
        f.setSize(900,650);
        f.setLocation(200,50); 
        f.setBackground(Color.white);
        f.setLayout(null);

        JLabel l1 = new JLabel("Enter Teacher ID to Update The Data of Teacher");
        ...
        id8.setBounds(270,10,500,50);
        id8.setFont(new Font("serif",Font.BOLD | Font.ITALIC,40));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b){
            try{
                Conn con = new Conn();
                String str = "update teacher set name='"+t1.getText()+"',fathers_name='"+t2.getText()+"',age='"+t3.getText()+"', dob='"+t4.getText()+"',address='"+t5.getText()+"',phone='"+t6.getText()+"',email='"+t7.getText()+"',class_x='"+t8.getText()+"',class_xii='"+t9.getText()+"',nid='"+t10.getText()+"', tcr_id = '"+t11.getText()+"',course='"+t13.getText()+"',dept='"+t14.getText()+"' where tcr_id='"+t12.getText()+"'";
        ...
        if(ae.getSource() == b2){
            try{
                Conn con = new Conn();
                String str = "select * from teacher where tcr_id = '"+t12.getText()+"'";
