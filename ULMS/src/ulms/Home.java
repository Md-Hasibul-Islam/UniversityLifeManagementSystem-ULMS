...
public class Home extends JFrame implements ActionListener{
    ...
    Home(){
        super("University Life Management System - ULMS");
        
        setSize(825, 573);
        setLocation(250, 100);
        
        ImageIcon ic =  new ImageIcon(ClassLoader.getSystemResource("ulms/images/Home.jpg"));
        ...
        admin.setForeground(new Color(15, 185, 220));
        
        
        m1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon1 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon1.png"));
        Image image1 = icon1.getImage().getScaledInstance(25, 25,Image.SCALE_DEFAULT);
        m1.setIcon(new ImageIcon(image1));
        m1.setMnemonic('A');
        m1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F, ActionEvent.CTRL_MASK));
        m1.setBackground(Color.WHITE);
        
        m2.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon2 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon2.png"));
        ...
        user.setForeground(new Color(255, 73, 21));
        
        u1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon4 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon3.png"));
        ...
        u2.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon5 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon4.jpg"));
        ...
        attendance.setForeground(new Color(15, 185, 220));
        
        a1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon23 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon14.jpg"));
        ...
        a2.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon25 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon15.png"));
        Image image26 = icon25.getImage().getScaledInstance(25, 25,Image.SCALE_DEFAULT);
        a2.setIcon(new ImageIcon(image26));
        a2.setMnemonic('N');
        a2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_I, ActionEvent.CTRL_MASK));
        ...
        attendance_detail.setForeground(new Color(255, 73, 21));
        
        b1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon27 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon15.png"));
        ...
        ImageIcon icon29 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon14.jpg"));
        ...
        exam.setForeground(new Color(15, 185, 220));
        
        c1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon30 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon16.png"));
        ...
        ImageIcon icon32 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon17.png"));
        ...
        report.setForeground(new Color(255, 73, 21));
        
        r1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon7 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon5.png"));
        ...
        ImageIcon iconn = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon6.png"));
        Image imagee = iconn.getImage().getScaledInstance(25, 25,Image.SCALE_DEFAULT);
        r2.setIcon(new ImageIcon(imagee));
        r2.setMnemonic('F');
        r2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_V, ActionEvent.CTRL_MASK));
        ...
        fee.setForeground(new Color(15, 185, 220));
        
        s1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon14 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon7.png"));
        Image image15 = icon14.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
        s1.setIcon(new ImageIcon(image15));
        s1.setMnemonic('G');
        s1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.CTRL_MASK));
        s1.setBackground(Color.WHITE);
        
        s1.addActionListener(this);
        
        s2.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon16 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon8.png"));
        Image image17 = icon16.getImage().getScaledInstance(20, 20,Image.SCALE_DEFAULT);
        s2.setIcon(new ImageIcon(image17));
        s2.setMnemonic('H');
        s2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
        ...
        utility.setForeground(new Color(255, 73, 21)); 
        

        ut1.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon18 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon9.png"));
        ...
        ut2.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon20 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon10.png"));
        ...
        ut3.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon10 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon11.png"));
        ...
        about.setForeground(new Color(15, 185, 220));
        
        aboutus.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon21 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon13.jpg"));
        ...
        exit.setForeground(new Color(255, 73, 21));
        

        ex.setFont(new Font("serif",Font.BOLD,16));
        ImageIcon icon11 = new ImageIcon(ClassLoader.getSystemResource("ulms/images/icon12.png"));
